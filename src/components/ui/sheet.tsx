  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          'fixed z-50 flex flex-col gap-4 bg-background shadow-lg transition ease-out data-[state=closed]:animate-out data-[state=closed]:ease-in data-[state=closed]:duration-300 data-[state=open]:animate-in data-[state=open]:ease-out data-[state=open]:duration-500',
          side === 'right' &&
